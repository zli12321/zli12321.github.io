...
(function () {
  ...
  const SOLVED_100 = {
    "Grok 4.5": 9,
    "Claude Sonnet 5": 5,
    "Claude Opus 4.8": 5, "Claude Fable 5": 7, "GPT-5.6": 4, "GPT-5.5": 5, "MiniMax M3": 3,
  ...
  const HORIZON = [
    ...
    { name: "GPT-5.6",            vendor: "OpenAI",    logo: "openai",         steps: 219, mins: 74, hours: 56 },
...
<svg viewBox="0 0 960 330" role="img" aria-label="An agent loops shell commands and observations against a container for hundreds of steps; a hidden verifier then replays the evidence into a graded reward">
  ...
  const SOLVED_T = {
    ...
    "GPT-5.6":             [9, 7, 4],   "GPT-5.5":        [8, 7, 5],   "MiniMax M3": [6, 3, 3],
